...
///////////////////////////////////////////////////////////////////////
    ...
    pinMode(dir_mo21e, OUTPUT);
    pinMode(dir_mo22e, OUTPUT);
...
void loop()
{
    ...
    if(motor_2>0)
   {
      ...
      analogWrite(pwm_mo2e,motor_2);
      digitalWrite(dir_mo21e,1);
      digitalWrite(dir_mo22e,0);
   }
   else
   {
      ...
      analogWrite(pwm_mo2e,-1*motor_2);
      digitalWrite(dir_mo21e,0);
      digitalWrite(dir_mo22e,1);
   }
   if(motor_3>0)
   {
   ...
   if(motor_5>0)
   {
      ...
      digitalWrite(dir_mo51ee,1);
      digitalWrite(dir_mo52ee,0);
      analogWrite(pwm_mo5ee,motor_5);
   ...
   else
   {
      ...
      analogWrite(pwm_mo5e,-1*motor_5);

      digitalWrite(dir_mo51ee,0);
      digitalWrite(dir_mo52ee,1);
      analogWrite(pwm_mo5ee,-1*motor_5);

     /* digitalWrite(dir_mo11e,0);
      digitalWrite(dir_mo12e,1);
      analogWrite(pwm_mo1e,(-1*motor_5));
    */
